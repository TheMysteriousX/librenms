...
Do not use tags to store sensitive information such as passwords. While there is the function to hide them, this is a UI choice and does not make them inaccessible.
...
Note that tags do not have to be defined before you create them as undefined tags are defined automatically - but you may want to.
See the 'Advanced Usage' section below for reasons why you might want to explicitly define a tag key before adding it to a device.
