...
Route::prefix('v0')->group(function () {
    ...
    Route::middleware(['can:global-read'])->group(function () {
        ...
        Route::get('tags/{key}', [App\Api\Controllers\LegacyApiController::class,'list_tags'])->name('list_device_tags');
        Route::get('tags/{key}/{value}', [App\Api\Controllers\LegacyApiController::class,'list_tags'])->name('list_device_tags');
